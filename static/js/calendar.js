...
;(function ($, window, document, undefined) {
    ...
    Calendar.prototype = {
        ...
        showCalendar: function () { // 输入数据并显示
            ...
            let haveWork=this.opts.haveWork;
            ...
            this.$calendarDate_item.each(function (i) {
                ...
                if (returnDateStr(new Date()) === allDay_str) {
                    $(this).attr('class', 'item-text item-curDay');
                } else if (returnDateStr(firstDay).substr(0, 6) === allDay_str.substr(0, 6)) {
                    $(this).attr('class', 'item-text item-curMonth');
                } else {
                    $(this).attr('class', 'item-text');
                }
                if (haveWork.indexOf(allDay_str) != -1) {
                    $(this).addClass('red-point');
                }
            });
        },
        ...
        renderDOM: function () { // 渲染DOM
            ...
            // var _dayStr = '';
            for (var i = 0; i < 5; i++) {
                _dateStr += '<li class="item"><div class="item-text">26</div></li>' +
                    '<li class="item"><div class="item-text">26</div></li>' +
                    '<li class="item"><div class="item-text">26</div></li>' +
                    '<li class="item"><div class="item-text">26</div></li>' +
                    '<li class="item"><div class="item-text">26</div></li>' +
                    '<li class="item"><div class="item-text">26</div></li>' +
        ...
        inital: function () { // 初始化
            ...
            this.$calendarDate_item = this.$calendar_date.find('.item-text');
            ...
            this.$calendarDate_item.bind('click', function () {
                var ck_date = $(this).attr("data")
                console.log(ck_date)
                window.location.href = "/calendar_search/" + ck_date;
            });
